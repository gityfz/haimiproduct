...
public class Test8 {
	public static void main(String[] args) {
        ...
        User2 u1 = new User2("张三", myCount, -4000, lock);
        User2 u2 = new User2("张三他爹", myCount, 6000, lock);
        User2 u3 = new User2("张三他弟", myCount, -8000, lock);
        User2 u4 = new User2("张三", myCount, 800, lock);
        //在线程池中执行各个用户的操作
        pool.execute(u1);
        pool.execute(u2);
        pool.execute(u3);
...
User2(String name, MyCount myCount, int iocash, Lock myLock) {
        this.name = name;
