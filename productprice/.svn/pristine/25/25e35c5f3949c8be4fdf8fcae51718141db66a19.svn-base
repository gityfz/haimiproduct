...
public class Test10 {
	public static void main(String[] args) {
		...
		MyThread4 t1 = new MyThread4("任务A", myPool, 3);
		MyThread4 t2 = new MyThread4("任务B", myPool, 12);
		MyThread4 t3 = new MyThread4("任务C", myPool, 7);
		// 在线程池中执行任务
...
class MyThread4 extends Thread {
	...
	MyThread4(String threadname, MyPool pool, int x) {
